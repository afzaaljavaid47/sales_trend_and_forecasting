                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="ibox bg-warning color-white widget-stat">
                            <div class="ibox-body">
                                ...
                                <div><a href="/user_predictions" style={{color:'white'}}><i class="fa fa-question-circle m-r-5"></i><small>View Predictions</small></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
...
<iframe width="900" height="500" src="https://www.youtube.com/embed/GrdkaVaA3oM" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>  </div>
            </div>
        </section>
